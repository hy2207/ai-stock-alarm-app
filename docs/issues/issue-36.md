# [UX-012] 추천 이력 아카이브·설정 정보 구조 UX 명세 — 종목별 이력 목록, 성공/실패 표기, realizedReturn, 설정 진입 경로

- Issue: #36
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/36
- Author: hy2207
- Created: 2026-05-14T12:10:13Z
- Updated: 2026-05-14T12:33:24Z
- Closed: Not closed
...
- **Task ID:** `UX-012`
- **Epic:** UI/UX Design
- **SRS / PRD:** SRS F8 REQ-FUNC-070, F1 REQ-FUNC-003
- **Complexity:** L
...
## Spec (local)
Source: `tasks/UX-012-Archive_settings_information_architecture.md`
