# [UX-004] 반응형·접근성 기준 정의 — PC/모바일 브라우저, 키보드 조작, focus, contrast, screen reader label, touch targ…

- Issue: #33
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/33
- Author: hy2207
- Created: 2026-05-14T12:09:54Z
- Updated: 2026-05-14T12:33:05Z
- Closed: Not closed
...
- **Task ID:** `UX-004`
- **Epic:** UI/UX Design
- **SRS / PRD:** SRS §3.1 Web/Mobile, REQ-NF-005, C-TEC-004
- **Complexity:** M
...
## Spec (local)
Source: `tasks/UX-004-Responsive_accessibility_baseline.md`
