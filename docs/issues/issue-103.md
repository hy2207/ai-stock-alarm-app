# [TEST-F2-01] [Test] 추천 카드 조회 GWT 단위 테스트 — 카드 ≤3개 반환, ticker/direction/confidenceScore 100% non-nul…

- Issue: #103
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/103
- Author: hy2207
- Created: 2026-05-14T12:21:14Z
- Updated: 2026-05-14T12:40:41Z
- Closed: Not closed
...
- **Task ID:** `TEST-F2-01`
- **Epic:** Test
- **SRS / PRD:** §F2 REQ-FUNC-010~013 AC
- **Complexity:** M
...
## Spec (local)
Source: `tasks/TEST-F2-01-Recommendation_card_query_test.md`
