# [UX-005] 로그인·세션 UX 명세 — OAuth/이메일 로그인, 미인증 리다이렉트, 세션 만료/재로그인, 보호 경로 안내

- Issue: #34
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/34
- Author: hy2207
- Created: 2026-05-14T12:10:00Z
- Updated: 2026-05-14T12:33:11Z
- Closed: Not closed
...
- **Task ID:** `UX-005`
- **Epic:** UI/UX Design
- **SRS / PRD:** SRS F10 REQ-FUNC-090~092
- **Complexity:** L
...
## Spec (local)
Source: `tasks/UX-005-Auth_session_ux_spec.md`
