# [AUTH-C02] [Command] Next.js Middleware 기반 인증 가드 구현 — 미인증 사용자를 `/login`으로 리다이렉트하는 세션 검증 로직

- Issue: #44
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/44
- Author: hy2207
- Created: 2026-05-14T12:11:02Z
- Updated: 2026-05-14T12:34:15Z
- Closed: Not closed
...
## Spec (local)
Source: `tasks/AUTH-C02-Auth_middleware_guard.md`
