# [DB-006] `EvidenceSnapshot` 모델 스키마 작성 — recId(FK), newsSignalScore, volumeSignalScore, communi…

- Issue: #38
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/38
- Author: hy2207
- Created: 2026-05-14T12:10:25Z
- Updated: 2026-05-14T12:33:37Z
- Closed: Not closed
...
- **Task ID:** `DB-006`
- **Epic:** Foundation
- **SRS / PRD:** §6.2.5 EvidenceSnapshot
- **Complexity:** L
...
## Spec (local)
Source: `tasks/DB-006-EvidenceSnapshot_model_schema.md`
