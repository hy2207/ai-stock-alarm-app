# [DTO-008] `/api/admin/health` 응답 DTO 정의 — `{ freshness, nullRate }`

- Issue: #4
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/4
- Author: hy2207
- Created: 2026-05-14T12:06:55Z
- Updated: 2026-05-14T12:29:57Z
- Closed: Not closed
...
## Spec (local)
Source: `tasks/DTO-008-Admin_health_response_dto.md`
