# [ARC-Q02] [Query/UI] 추천 이력 목록 화면 구현 — 종목별 리스트 뷰, 성공/실패 표기, shadcn/ui Table/Card

- Issue: #73
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/73
- Author: hy2207
- Created: 2026-05-14T12:14:08Z
- Updated: 2026-05-14T12:37:26Z
- Closed: Not closed
...
## Spec (local)
Source: `tasks/ARC-Q02-Recommendation_history_list_ui.md`

## :dart: Summary
- 기능명: [ARC-Q02] 추천 이력 목록 화면 구현
- 목적: 추천 이력 목록 화면 구현을(를) 통해 종목별 과거 추천 결과와 성공/실패 이력을 추적 가능하게 한다.

## :link: References (Spec & Context)
> :bulb: AI Agent & Dev Note: 작업 시작 전 아래 문서를 반드시 먼저 Read/Evaluate 할 것.
- SRS 문서: [`/tasks/SRS-v1.md`](./SRS-v1.md) — §F8 REQ-FUNC-070
- 태스크 목록: [`/tasks/task-list-v1.md`](./task-list-v1.md) — ARC-Q02 / Archive / 복잡도 M
