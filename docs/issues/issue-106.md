# [UX-015] 제품 이벤트·설문 터치포인트 UX 맵 — rec_card_view, confidence_view/change, reason_expand, performa…

- Issue: #106
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/106
- Author: hy2207
- Created: 2026-05-14T12:21:32Z
- Updated: 2026-05-14T12:41:01Z
- Closed: Not closed
...
- **Task ID:** `UX-015`
- **Epic:** UI/UX Design
- **SRS / PRD:** PRD §1.2, §5.4, SRS F7 REQ-FUNC-060~061
- **Complexity:** M
...
## Spec (local)
Source: `tasks/UX-015-Analytics_survey_touchpoint_ux_map.md`
