# [MOCK-004] 외부 API Mock 설정 — Yahoo Finance/Finnhub OHLCV + 뉴스 응답 고정 Mock JSON

- Issue: #8
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/8
- Author: hy2207
- Created: 2026-05-14T12:07:22Z
- Updated: 2026-05-14T12:30:23Z
- Closed: Not closed
...
## Spec (local)
Source: `tasks/MOCK-004-External_market_api_mock_data.md`

## :dart: Summary
- 기능명: [MOCK-004] 외부 API Mock 설정
- 목적: 외부 API Mock 설정을(를) 고정 fixture로 제공하여 백엔드 구현 전에도 UI, 테스트, 스토리북 검증이 가능하게 한다.

## :link: References (Spec & Context)
> :bulb: AI Agent & Dev Note: 작업 시작 전 아래 문서를 반드시 먼저 Read/Evaluate 할 것.
- SRS 문서: [`/tasks/SRS-v1.md`](./SRS-v1.md) — §3.1 외부 시스템
- 태스크 목록: [`/tasks/task-list-v1.md`](./task-list-v1.md) — MOCK-004 / Foundation / 복잡도 M
- 제품/비즈니스 배경: [`/tasks/PRD_v1.md`](./PRD_v1.md)

## :white_check_mark: Task Breakdown (실행 계획)
- [ ] SRS의 §3.1 외부 시스템 요구사항과 MOCK-004 태스크 범위를 재확인
- [ ] 선행 태스크 상태 확인: 선행 태스크 없음
- [ ] UI/테스트용 mock 데이터 fixture의 파일 위치와 공개 인터페이스 결정
- [ ] 외부 API Mock 설정에 필요한 정상/경계/빈 상태 mock 데이터 정의
...
- Given: UI 개발자가 외부 API Mock 설정 fixture를 import함
...
- 범위: MOCK-004는 외부 API Mock 설정 — Yahoo Finance/Finnhub OHLCV + 뉴스 응답 고정 Mock JSON에 한정하며 unrelated refactor를 포함하지 않는다.
- 의존성: 독립 실행 가능해야 한다.
