# [UX-006] 온보딩·관심 종목 설정 UX 명세 — 최소 1개/최대 3개 선택, 초과 선택 차단, 설정 화면 수정 흐름

- Issue: #35
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/35
- Author: hy2207
- Created: 2026-05-14T12:10:07Z
- Updated: 2026-05-14T12:33:18Z
- Closed: Not closed
...
- **Task ID:** `UX-006`
- **Epic:** UI/UX Design
- **SRS / PRD:** SRS F1 REQ-FUNC-001~003, PRD §4.1 Must
- **Complexity:** M
...
## Spec (local)
Source: `tasks/UX-006-Onboarding_watchlist_settings_ux_spec.md`
