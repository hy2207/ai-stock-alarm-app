# [UX-008] 추천 상세·차트 없는 결과 해석 UX 명세 — 메인 폴드 차트 비노출, 상세 정보 배치, 유사 패턴/성과 영역 진입

- Issue: #82
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/82
- Author: hy2207
- Created: 2026-05-14T12:15:03Z
- Updated: 2026-05-14T12:38:24Z
- Closed: Not closed
...
- **Task ID:** `UX-008`
- **Epic:** UI/UX Design
- **SRS / PRD:** SRS REQ-FUNC-012, REQ-FUNC-014, ADR-004
- **Complexity:** M
...
## Spec (local)
Source: `tasks/UX-008-Recommendation_detail_chartless_ux_spec.md`
