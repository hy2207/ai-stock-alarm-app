# [UX-009] Confidence Score 선택 인터랙션 명세 — aggressive/balanced/conservative 3단계, 변경값 피드백, 300ms 전환…

- Issue: #83
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/83
- Author: hy2207
- Created: 2026-05-14T12:15:09Z
- Updated: 2026-05-14T12:38:30Z
- Closed: Not closed
...
- **Task ID:** `UX-009`
- **Epic:** UI/UX Design
- **SRS / PRD:** SRS F4 REQ-FUNC-030~033, REQ-NF-003, ADR-002
- **Complexity:** H
...
## Spec (local)
Source: `tasks/UX-009-Confidence_score_interaction_spec.md`
