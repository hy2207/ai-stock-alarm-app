# [LLM-C03] [Command] LLM 프롬프트 구성 모듈 — watchlist, OHLCV 요약, 뉴스 시그널, risk_mode 4종 컨텍스트 조합, 3벌 카드(a…

- Issue: #61
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/61
- Author: hy2207
- Created: 2026-05-14T12:12:51Z
- Updated: 2026-05-14T12:36:07Z
- Closed: Not closed
...
- **Task ID:** `LLM-C03`
- **Epic:** LLM Pipeline
- **SRS / PRD:** §F9 REQ-FUNC-082, REQ-FUNC-085
- **Complexity:** H
...
## Spec (local)
Source: `tasks/LLM-C03-LLM_prompt_builder.md`
