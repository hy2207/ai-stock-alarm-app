# [UX-010] No Call·loading·empty·error 상태 UX/콘텐츠 명세 — LLM 실패, 데이터 부족, 성과 부족, 사용자에게 5xx 미노출

- Issue: #94
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/94
- Author: hy2207
- Created: 2026-05-14T12:16:35Z
- Updated: 2026-05-14T12:39:43Z
- Closed: Not closed
...
- **Task ID:** `UX-010`
- **Epic:** UI/UX Design
- **SRS / PRD:** SRS REQ-FUNC-013, REQ-FUNC-042, REQ-FUNC-083
- **Complexity:** M
...
## Spec (local)
Source: `tasks/UX-010-State_content_no_call_empty_error.md`
