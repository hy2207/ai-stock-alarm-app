# [MON-003] PostHog 제품 KPI 대시보드 세팅 — ADR, CTR, Confidence Engagement Rate, 성과 카드 열람률, D7/D30 Rete…

- Issue: #118
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/118
- Author: hy2207
- Created: 2026-05-14T12:22:45Z
- Updated: 2026-05-14T12:42:20Z
- Closed: Not closed
...
## Spec (local)
Source: `tasks/MON-003-PostHog_kpi_dashboard.md`

## :dart: Summary
- 기능명: [MON-003] PostHog 제품 KPI 대시보드 세팅
- 목적: PostHog 제품 KPI 대시보드 세팅을(를) 통해 운영 상태, 데이터 freshness, 실패율을 탐지하고 대응 가능하게 한다.

## :link: References (Spec & Context)
> :bulb: AI Agent & Dev Note: 작업 시작 전 아래 문서를 반드시 먼저 Read/Evaluate 할 것.
- SRS 문서: [`/tasks/SRS-v1.md`](./SRS-v1.md) — §4.2.5 REQ-NF-040
- 태스크 목록: [`/tasks/task-list-v1.md`](./task-list-v1.md) — MON-003 / Infra/Ops / 복잡도 M
...
- [ ] SRS의 §4.2.5 REQ-NF-040 요구사항과 MON-003 태스크 범위를 재확인
- [ ] 선행 태스크 상태 확인: EVT-Q01
- [ ] 운영 모니터링 엔드포인트 또는 대시보드의 파일 위치와 공개 인터페이스 결정
- [ ] PostHog 제품 KPI 대시보드 세팅 모니터링 대상과 지표 정의
...
- When: PostHog 제품 KPI 대시보드 세팅 모니터링을 확인함
...
- 범위: MON-003는 PostHog 제품 KPI 대시보드 세팅 — ADR, CTR, Confidence Engagement Rate, 성과 카드 열람률, D7/D30 Retention 대시보드에 한정하며 unrelated refactor를 포함하지 않는다.
- 의존성: EVT-Q01 완료 상태를 전제로 한다.
