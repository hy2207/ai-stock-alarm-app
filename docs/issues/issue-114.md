# [REC-Q05] [Query/UI] 차트 위젯 비노출 검증 — 메인 폴드 영역에 캔들/RSI/MACD 미렌더링 (디자인 QA)

- Issue: #114
- State: OPEN
- URL: https://github.com/hy2207/ai-stock-alarm-app/issues/114
- Author: hy2207
- Created: 2026-05-14T12:22:21Z
- Updated: 2026-05-14T12:41:55Z
- Closed: Not closed
...
- **Task ID:** `REC-Q05`
- **Epic:** Recommendation
- **SRS / PRD:** §F2 REQ-FUNC-014, ADR-004
- **Complexity:** L
...
## Spec (local)
Source: `tasks/REC-Q05-Chart_widget_exclusion_qa.md`

## :dart: Summary
- 기능명: [REC-Q05] 차트 위젯 비노출 검증
- 목적: 차트 위젯 비노출 검증을(를) 통해 사용자가 홈과 상세 화면에서 실행 가능한 추천 카드 정보를 오류 없이 확인하게 한다.

## :link: References (Spec & Context)
> :bulb: AI Agent & Dev Note: 작업 시작 전 아래 문서를 반드시 먼저 Read/Evaluate 할 것.
- SRS 문서: [`/tasks/SRS-v1.md`](./SRS-v1.md) — §F2 REQ-FUNC-014, ADR-004
- 태스크 목록: [`/tasks/task-list-v1.md`](./task-list-v1.md) — REC-Q05 / Recommendation / 복잡도 L
